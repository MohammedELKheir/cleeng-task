...
return array(
    ...
    'properties' => [
        'creator'        => 'CleengTask',
        'lastModifiedBy' => 'CleengTask',
        'title'          => 'Statistics',
        'description'    => 'Default spreadsheet export for statistics',
        'subject'        => 'Spreadsheet export for statistics',
        'keywords'       => 'CleengTask, excel, export,statistics',
        'category'       => 'Excel',
        'manager'        => 'CleengTask',
        'company'        => 'CleengTask',
    ],
